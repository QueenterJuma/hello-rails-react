<div align="center">
  ...
  <h3><b>Rails-react-back-end</b></h3>
...
# 📖 [Rails-react-back-end] <a name="about-project"></a>
  ...
  **[Rails-react-back-end]** is app build using ruby on rails and react
...
```sh
  cd my-folder
  https://github.com/QueenterJuma/rails-react-back-end.git
```
...
Feel free to check the [issues page](https://github.com/QueenterJuma/rails-react-back-end/issues).
